...
const UlasanTransport = ({ route, navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity 
        ...
        onPress={() => navigation.navigate('TambahKomentarTransport', { title: title })}
      >
        <Icon style={{
                             marginRight:5,
                             top:-2
...
export default UlasanTransport;