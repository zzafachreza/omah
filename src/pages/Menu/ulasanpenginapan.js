...
const UlasanPenginapan = ({ route, navigation }) => {
...
<TouchableOpacity 
        ...
        onPress={() => navigation.navigate('TambahKomentarPenginapan', { title: title })}
      >
               <Icon style={{
                                    marginRight:5,
                                    top:-2
...
export default UlasanPenginapan;